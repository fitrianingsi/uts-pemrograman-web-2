    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('films.index') }}" class="row g-2 mb-4">
                <div class="col-md-5">
                    <input type="text" name="search" value="{{ $search }}" class="form-control" placeholder="Cari judul/director...">
                </div>
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('films.index') }}" class="btn btn-secondary w-100">Reset</a>
                </div>
            </form>
